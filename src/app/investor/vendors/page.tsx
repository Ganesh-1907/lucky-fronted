...
export default function VendorAnalyticsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: "var(--font-outfit)" }}>Vendor Analytics</h1>
        <p className="text-sm text-gray-500 mt-1">Analyze vendor onboarding, category market shares, and performance leaderboards.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {/* Vendor Leaderboard */}
        <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl p-5 flex flex-col">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2" style={{ fontFamily: "var(--font-outfit)" }}>
                ...
                <tbody className="divide-y divide-gray-100/40">
                  {currentLeaderboard.map((vendor: any, idx: number) => (
                    <tr key={vendor.id} className="hover:bg-gray-700/20 transition-colors group">
                      ...
                      {activeTab !== "rating" && (
                        <td className="py-3.5 text-right font-semibold text-violet-600">
                ...
                return (
                  <div key={idx} className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-medium text-violet-600">{formatPrice(cat.revenue || 0)}</span>
                    </div>
